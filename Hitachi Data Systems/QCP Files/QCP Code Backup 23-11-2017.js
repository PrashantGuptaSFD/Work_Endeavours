//QCP Code
	...
	console.log('>> Entry')
	  ...
	  if (lines != null && lines.length > 0) {
		...
		console.log('>>');
		console.log('>> ' + JSON.stringify(lines[0].record['SBQQ__Quote__c']));
		console.log('>> ' + JSON.stringify(lines[0].record['SBQQ__Product__c']));
	...
	function applyDiscountsOnLineItem(line, obj, ruleNumber) {
		console.log('LOG>>>>>>>>>>>>>>>>.' + obj['discount']);
		console.log('LOG>>>>>>>>>>>>>>>>.' + obj['type']);
