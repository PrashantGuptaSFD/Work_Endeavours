	//QCP Code
			...
			return conn.query(query)
			  .then(function(results) {
				if (results.totalSize) {
				  ...
				  initRAFDiscountRule1(lines, conn, objQuote);
		...
		function initRAFDiscountRule1(lines,conn, objQuote){
			var productPcodeSet = [];
			...
			.then(function(results) {		
				...
				if (remainingLines.length) {
					...
					initRAFDiscountRule2(remainingLines, conn, objQuote);
				}
			});
		}
		...
		function initRAFDiscountRule2(lines,conn, objQuote){
			...
			.then(function(results) {		
				...
				if (remainingLines.length) {
					console.log('Inside remaining lines: RAF ');
					initRAFDiscountRule3(remainingLines, conn, objQuote);
				}
			});
		}
