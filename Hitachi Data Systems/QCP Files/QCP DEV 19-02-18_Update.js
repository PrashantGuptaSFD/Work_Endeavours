...
function applyDiscountsOnLineItem(line, obj, ruleNumber,log) {
  ...
  var trimmedLog = updatedLog.substring(0, 255);
  console.log('Log generated for Partner/Customer Rule == ' + trimmedLog);
  
  line.record['Customer_Partner_Logs__c'] = trimmedLog;
...
function applyDiscountsOnLineItemRAF(line, obj, ruleNumber,log) {
  ...
  var trimmedLog = updatedLog.substring(0, 255);
  console.log('Log generated for RAF == ' + trimmedLog);
  
  line.record['RAF_Logs__c'] = trimmedLog;
